...
import com.sfc.myapplication.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng SFC = new LatLng(35.388279, 139.427307);
        //mMap.addMarker(new MarkerOptions().position(SFC).title("Marker in SFC"));
